            ...
            <div className={classes.paper}>
                ...
                <div className={classes.socialButton}>
                    <Button
                        ...
                        variant="outlined"
                        style={{
                            borderRadius: 25, margin: theme.spacing(1, 0, 1),textTransform: "none",fontWeight:'bold',
                ...
                <form className={classes.form} onSubmit={handleSubmit}>
                    ...
                    <Button
                        ...
                        className={classes.submit}
                            style={{borderRadius: 25, color: 'white',height: '50px'}}
                    >
                        Log In
                    </Button>
                    <Grid container justify="center">
                        <Grid item>
                            <Link to="/register" variant="body2" style={{textDecoration: 'none', color: 'var(--color-text-dark)',fontWeight:'bold'}}>
                                New here? Sign Up
                            </Link>
                        </Grid>
                    </Grid>
